...
/*****************************************************************************************
******************************************************************************************
Functions for CodeGenTileLangNPUIRMLIR class
Todo: Remove CodeGenTileLangNPUIR class and use all functions from
CodeGenTileLangNPUIRMLIR
******************************************************************************************
******************************************************************************************/

void CodeGenTileLangNPUIRMLIR::SmartMemRefCopy(mlir::Value src, mlir::Value dst) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::ScalarConvertType(const PrimExpr &imm,
                                                       DataType targetDtype) {
  auto castNode = std::make_unique<tir::Cast>(targetDtype, imm);
  return MakeValue(*castNode);
}

CodeGenTileLangNPUIRMLIR::CodeGenTileLangNPUIRMLIR() : builder(&context) {
...
std::string CodeGenTileLangNPUIRMLIR::Finish() {
  std::string mlirCode;
...
CodeGenTileLangNPUIRMLIR::GetHIVMAddressSpace(String address_space) {
...
CodeGenTileLangNPUIRMLIR::GetShape(Array<PrimExpr> shape_in) {
...
mlir::Type CodeGenTileLangNPUIRMLIR::GetMLIRType(const PrimExpr &expr) {
  auto ttype = GetType(expr);
  auto DType = GetRuntimeDataType(ttype);
  return DTypetoMLIRType(DType);
}

mlir::Type CodeGenTileLangNPUIRMLIR::GetMLIRType(const Buffer &buffer) {
...
void CodeGenTileLangNPUIRMLIR::VisitStmt_(const tir::ForNode *op) {
...
void CodeGenTileLangNPUIRMLIR::VisitStmt_(const tir::IfThenElseNode *op) {
...
mlir::Type CodeGenTileLangNPUIRMLIR::DTypetoMLIRType(DataType t) { // NOLINT(*)
  int lanes = t.lanes();
  if (t.is_handle()) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const FloorDivNode *op) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const FloorModNode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  mlir::Value mlirVal;
  if (op->dtype.is_int() || op->dtype.is_uint()) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const LTNode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  mlir::Value mlirVal;
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const NENode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  mlir::Value mlirVal;
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const EQNode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  mlir::Value mlirVal;
  if (op->a->dtype.is_int() || op->a->dtype.is_uint()) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const LENode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  mlir::Value mlirVal;
  if (op->a->dtype.is_int()) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const GENode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  mlir::Value mlirVal;
  if (op->a->dtype.is_int()) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const GTNode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  mlir::Value mlirVal;
  if (op->a->dtype.is_int()) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const CastNode *op) {
  bool srcIsFloat =
...
mlir::Value CodeGenTileLangNPUIRMLIR::GenSubviewFromRegion(Buffer buffer_data,
                                                          Array<Range> range) {
  /*
...
mlir::Value CodeGenTileLangNPUIRMLIR::CreateIndexCastOp(mlir::Value src) {
...
inline std::pair<bool, mlir::Value> CodeGenTileLangNPUIRMLIR::CheckMLIRValueMap(mlir::Value val){
...
inline void CodeGenTileLangNPUIRMLIR::UpdateMLIRValueMap(const mlir::Value key, mlir::Value val){
  mlir::Block *curr_block = builder.getInsertionBlock();
  this->mlir_value_map[{key, curr_block}] = val;
}

inline std::pair<bool, mlir::Value> CodeGenTileLangNPUIRMLIR::CheckPrimExprMap(const PrimExprNode * op){
  mlir::Block *curr_block = builder.getInsertionBlock();
...
inline void CodeGenTileLangNPUIRMLIR::UpdatePrimExprMap(const PrimExprNode * key, mlir::Value val){
  mlir::Block *curr_block = builder.getInsertionBlock();
...
mlir::Value CodeGenTileLangNPUIRMLIR::BinaryOpCodegen(const PrimExprNode *op,
...
///   memref.copy
void CodeGenTileLangNPUIRMLIR::AscendCopyCodegen(const CallNode *op) {
...
template <typename T, typename U>
void CodeGenTileLangNPUIRMLIR::UnaryVecOpCodegen(const CallNode *op) {
...
void CodeGenTileLangNPUIRMLIR::VflipCodegen(const CallNode *op) {
...
void CodeGenTileLangNPUIRMLIR::Nz2NdCodegen(const CallNode *op) {
...
void CodeGenTileLangNPUIRMLIR::FixpipeCodegen(const CallNode *op) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::GenMemrefLoadFromRegion(const BufferLoadNode *op) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::GetEventID(PrimExpr id) {
...
template <typename T, typename U>
void CodeGenTileLangNPUIRMLIR::PipeFlagCodegen(const CallNode *op) {
...
void CodeGenTileLangNPUIRMLIR::DebugPrintCodegen(const CallNode *op) {
  std::string prefix = "";
  bool hex = false;
  mlir::Value arg;
...
void CodeGenTileLangNPUIRMLIR::VcosCodegen(const CallNode *op) {
...
//   - store the final result into destination vector
//   - all intermediate results are lowered to vector operations on memref subviews
void CodeGenTileLangNPUIRMLIR::VsinCodegen(const CallNode *op) {
...
//   - store the final result into destination vector
//   - all intermediate results are lowered to vector operations on memref subviews
void CodeGenTileLangNPUIRMLIR::VerfCodegen(const CallNode *op) {
...
//   - store the final result into destination vector
//   - all intermediate results are lowered to vector operations on memref subviews
void CodeGenTileLangNPUIRMLIR::VtanhCodegen(const CallNode *op) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const CallNode *op) {
...
void CodeGenTileLangNPUIRMLIR::VisitStmt_(const LetStmtNode *op) {
...
void CodeGenTileLangNPUIRMLIR::VisitStmt_(const AttrStmtNode *op) {
...
template <typename T>
mlir::Value CodeGenTileLangNPUIRMLIR::GetAndCastIndexOp(const IterVar iv) {
...
void CodeGenTileLangNPUIRMLIR::VisitStmt_(const AllocateNode *op) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const MinNode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  mlir::Value mlirVal;
  if (op->dtype.is_int()) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const MaxNode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  mlir::Value mlirVal;
  if (op->dtype.is_int()) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const AddNode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  mlir::Value mlirVal;
  if (op->dtype.is_int() || op->dtype.is_uint()) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const SubNode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  mlir::Value mlirVal;
  if (op->dtype.is_int() || op->dtype.is_uint()) {
...
mlir::Value
CodeGenTileLangNPUIRMLIR::VisitExpr_(const FloatImmNode *op) {
  // check if same node already created
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const IntImmNode *op) {
  // check if same node already created
  // If already created return corresponding MLIR value and do not create duplicated MLIR Op
  std::pair<bool, mlir::Value> result = CheckPrimExprMap(op);
  if (result.first){
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const MulNode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  mlir::Value mlirVal;
  if (op->dtype.is_int() || op->dtype.is_uint()) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const AndNode *op) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const OrNode *op) {
  CHECK(op->a.dtype().is_int() || op->a.dtype().is_uint());
  CHECK(op->b.dtype().is_int() || op->b.dtype().is_uint());
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const DivNode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  auto mlirVal =
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const SelectNode *op) {
...
String CodeGenTileLangNPUIRMLIR::GetCurrentFunctionName(){
  return this->current_function_name;
}

void CodeGenTileLangNPUIRMLIR::AddFunctionForCoreType(const GlobalVar &gvar,
                                                     const PrimFunc &f) {
...
void CodeGenTileLangNPUIRMLIR::InitFuncState() {
  var_map_.clear();
...
void CodeGenTileLangNPUIRMLIR::AddFunction(const GlobalVar& gvar, const PrimFunc& f)
{
...
mlir::Value CodeGenTileLangNPUIRMLIR::GetVarValue(const VarNode *v) const {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const StringImmNode *op) {
  // Todo: Implementation pending
  LOG(FATAL) << "StringImmNode case not supported!";
}

mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const ModNode *op) {
  auto lhs = MakeValue(op->a);
  auto rhs = MakeValue(op->b);
  mlir::Value mlirVal;
  if (op->dtype.is_int() || op->dtype.is_uint()) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const NotNode *op) {
  // check if same node already created
  // If already created return corresponding MLIR value and do not create duplicated MLIR Op
  std::pair<bool, mlir::Value> result = CheckPrimExprMap(op);
  if (result.first){
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const LetNode *op) {
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const BufferLoadNode *op) {
  auto buffer = op->buffer;
  auto indices = op->indices;
...
mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const RampNode *op) {
  // Todo: Implementation pending
  LOG(FATAL) << "RampNode case not supported!";
}

mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const ShuffleNode *op) {
  // Todo: Implementation pending
  LOG(FATAL) << "ShuffleNode case not supported!";
}

mlir::Value CodeGenTileLangNPUIRMLIR::VisitExpr_(const BroadcastNode *op) {
  // Todo: Implementation pending
  LOG(FATAL) << "BroadcastNode case not supported!";
}

void CodeGenTileLangNPUIRMLIR::VisitStmt_(const BufferStoreNode *op) {
  auto buffer = op->buffer;
  auto value = op->value;
  auto indices = op->indices;
...
void CodeGenTileLangNPUIRMLIR::VisitStmt_(const WhileNode *op) {
  // Todo: Implementation pending
  LOG(FATAL) << "WhileNode case not supported!";
}

void CodeGenTileLangNPUIRMLIR::VisitStmt_(const AllocateConstNode *op) {
  // Todo: Implementation pending
  LOG(FATAL) << "AllocateConstNode case not supported!";
}

void CodeGenTileLangNPUIRMLIR::VisitStmt_(const AssertStmtNode *op) {
  // Todo: Implementation pending
  LOG(FATAL) << "AssertStmtNode case not supported!";
}

void CodeGenTileLangNPUIRMLIR::VisitStmt_(const SeqStmtNode *op) {
  // EmitDebugLocation(op);
...
void CodeGenTileLangNPUIRMLIR::VisitStmt_(const EvaluateNode *op) {
  // EmitDebugLocation(op);
  MakeValue(op->value);
}

void CodeGenTileLangNPUIRMLIR::VisitStmt_(const DeclBufferNode *op) {
  // EmitDebugLocation(op);
  VisitStmt(op->body);
}
